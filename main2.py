...
class VQAModel(nn.Module):
    ...
    def forward(self, image, question):
        ...
        out, (question_feature, _) = self.lstm(embedded)
...
def main():
    ...
    model = VQAModel(vocab_size=len(train_dataset.vocab2idx)+1, embed_size=embed_size, hidden_size=hidden_size, n_answer=len(train_dataset.vocab2idx)).to(device)
    print('model_load')
    # optimizer / criterion
    num_epoch = 20
